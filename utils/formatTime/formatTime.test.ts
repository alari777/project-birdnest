...
describe('testing function formatTime(), right values', () => {
  it('should return date in new format', () => {
    ...
    expect(result).toBe('11.12.2022 19:48:16 in UTC');
  });
